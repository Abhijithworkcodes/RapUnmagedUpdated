...
METHOD create.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zap_u_str_travel_x( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZAP_CDS_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZAP_CDS_TRAVEL_U IMPLEMENTATION.
